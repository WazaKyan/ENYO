...
> **Avancement (poussé sur GitHub) :** Phases **0, 1, 2, 3, 4 ✅** · Systèmes **S1–S4 + IA baseline** faits · à venir : militaire/diplomatie (conflit), 5 (Directeur DeepSeek), 7 (UI). **29 tests** verts, clippy propre.
