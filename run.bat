...
echo ============================================================
"%CARGO%" run --release -q -p harness -- --seed 2026 --nations 8 --turns 150 --director --player 0 --png "out\monde.png" --png-scale 2 --region "out\civilisations.png" --region-scale 14 --tileset "out\tileset.png" --tileset-scale 16
